...
func GenerateTask(subject, topic, difficulty, classNum string) string {
	req := &gigachat.ChatRequest{
		...
		Messages: []gigachat.Message{
			{
				Role: "user",
				Content: fmt.Sprintf(`Создай 1 задание по %s, для %s класса по теме %s в формате вопроса и 4 вариантов ответов от А до Г русскими буквами, один из этих вариантов должен быть правильным на задание, а другие должны быть ложными.
